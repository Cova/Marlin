...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  33, 270 }, { 152,  152 } }  // Set number of iterations to align
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE   3000  // (mm/s) Unload filament feedrate. This can be pretty fast.
