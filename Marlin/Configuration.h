...
#define CUSTOM_MACHINE_NAME "iPrint HyperCube"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //iPrint HyperCube
  #define DEFAULT_Kp 15.15
  #define DEFAULT_Ki 0.97
  #define DEFAULT_Kd 59.46
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //iPrint HyperCube - 24V A5 Bed.
  #define DEFAULT_bedKp 74.78
  #define DEFAULT_bedKi 14.59
  #define DEFAULT_bedKd 255.54
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 29, 7, -2.1 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (29)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT (7)    // Y point for Z homing when homing all axes (G28).
#endif
